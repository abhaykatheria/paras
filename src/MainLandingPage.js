...
const FeatureIcon = tw(CheckboxIcon)
`w-5 h-5 text-primary-500`;
const FeatureText = tw.p `ml-2 font-medium text-gray-700`;
const ImageColumn = tw(Column)
`mx-auto lg:mr-0 relative mt-16 lg:mt-0 lg:ml-8`;
...
`text-primary-900`;
const SectionDescription = tw(DescriptionBase)
...
const PreviewCard = tw(motion.a)
`block rounded-lg shadow-raised`;
