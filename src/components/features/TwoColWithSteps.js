...
export default ({
  ...
  const defaultSteps = [
    {
      heading: "Call us",
      description: "Contact us for maintanence of your fire safety equipments."
    },
    {
      heading: "Schedule",
      description: "Set a date that best suits for both of us."
    },
    {
      heading: "On-site Maintenance",
      description: "Our team will visit your site and do the maintenance."
    }
  ];
